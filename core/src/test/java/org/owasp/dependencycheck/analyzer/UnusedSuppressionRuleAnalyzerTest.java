...
class UnusedSuppressionRuleAnalyzerTest extends BaseTest {
    ...
    private SuppressionRule getSuppressionRule(boolean matching) {
        ...
        instance.addVulnerabilityName(new PropertyType("CVE-2023-5072", false, false));
        instance.setPackageUrl(new PropertyType("^pkg:maven/test." + PACKAGE_NAME + "." + matching, false, false));
        instance.addCpe(new PropertyType(PACKAGE_NAME, false, false));
